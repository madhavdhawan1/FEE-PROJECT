...
const TestimonialData = [
  {
    id: 1,
    name: "Fahaam Khan",
    text: "I am always confused when i shop clothes but when i go through to ShopEasy, I find the perfect place. ",
    // img: "https://picsum.photos/101/101",
  },
  {
    id: 2,
    name: "Nitish Mittal",
    text: "ShopEasy always provides the premium designs . I love to shopping with ShopEasy",
